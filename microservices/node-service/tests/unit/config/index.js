  ...
  describe('getConfig', () => {
    it('should return default values', done => {
      config.getConfig().then(c => {
        ...
        c.mongoUrl.should.equal('mongodb://localhost:27017/teams')
    ...
    it('should return values from environment variables', done => {
      ...
      config.getConfig().then(c => {
        ...
        c.mongoUrl.should.equal('mongodb://mongo.mlab.com:27017/teams')
    ...
    it('should return values from files', done => {
      ...
      config.getConfig().then(c => {
        ...
        c.mongoUrl.should.equal('mongodb://user:pass@mongo1:27017,mongo2:27017,mongo3:27017/teams')
